...
function createBot(req, res, next) {
  logger.winston.info('Bot.createBot');
    db.run('insert into bots(bot_id, bot_name, bot_config, output_folder)' + 'values (?,?,?,?)', [req.body.bot_id, req.body.bot_name, req.body.bot_config, req.body.output_folder], function(err) {
      if (err) {
